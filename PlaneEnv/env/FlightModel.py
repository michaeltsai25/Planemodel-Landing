...
from ..utils import write_to_txt_general
...
class FlightModel:
    def __init__(self):
        ...
        self.V = [(100), (0)]  # Speed Vector ==> 228 m/s is the typical cruising speed for the Airbus A320
        self.Pos = [(0), (100)]  # Position vector
    ...
    def compute_timestep(self, action, number_timesteps):
        ...
        thrust_factor = 0 #shift the thrust percentage from 0 to 50%, to 50% to 100% ==> edit
...
if __name__ == "__main__":
    ...
    #write_to_txt_general(environment)
    animate_plane()
